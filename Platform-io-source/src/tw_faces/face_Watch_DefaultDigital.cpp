...
bool FaceWatch_DefaultDigital::click(uint pos_x, uint pos_y)
{
	return false;
}

bool FaceWatch_DefaultDigital::click_double(uint pos_x, uint pos_y)
{
...
bool FaceWatch_DefaultDigital::click_long(uint pos_x, uint pos_y)
{
