...
bool FaceWatch_DefaultAnalog::click(uint pos_x, uint pos_y)
{
	return false;
}

bool FaceWatch_DefaultAnalog::click_double(uint pos_x, uint pos_y)
{
...
bool FaceWatch_DefaultAnalog::click_long(uint pos_x, uint pos_y)
{
