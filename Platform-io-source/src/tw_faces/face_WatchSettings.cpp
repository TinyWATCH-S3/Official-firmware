...
bool FaceWatchSettings::click(uint pos_x, uint pos_y)
{
	return false;
}

bool FaceWatchSettings::click_double(uint pos_x, uint pos_y)
{
	return false;
}

bool FaceWatchSettings::click_long(uint pos_x, uint pos_y)
{
	return false;
}
