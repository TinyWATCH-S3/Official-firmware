...
bool FaceWatch_CustomBinary::click(int16_t pos_x, int16_t pos_y)
{
...
bool FaceWatch_CustomBinary::click_double(int16_t pos_x, int16_t pos_y)
{
...
bool FaceWatch_CustomBinary::click_long(int16_t pos_x, int16_t pos_y)
{
