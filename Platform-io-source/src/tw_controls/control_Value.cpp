...
void ControlValue::set_data(SettingsOptionInt *sett)
{
	setting_option = sett;
}
...
bool ControlValue::drag(int16_t drag_x, int16_t drag_y)
{
	return false;
}
...
bool ControlValue::click_double(uint16_t click_pos_x, uint16_t click_pos_y)
{
	return false;
}

bool ControlValue::click_long(uint16_t click_pos_x, uint16_t click_pos_y)
{
	return false;
}

bool ControlValue::buttons_check_left(uint click_pos_x, uint click_pos_y)
{
	int min_x, min_y = 0;
	int max_x = 240;
	int max_y = 280;
...
bool ControlValue::buttons_check_right(uint click_pos_x, uint click_pos_y)
{
	int min_x, min_y = 0;
	int max_x = 240;
	int max_y = 280;
