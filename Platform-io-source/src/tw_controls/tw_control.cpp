...
void tw_control::set_callback(CallbackFunction callback)
{
...
void tw_control::set_parent(tw_face *_parent)
{
	parent = _parent;
}

bool tw_control::bounds_check(uint click_pos_x, uint click_pos_y)
{
	int min_x, min_y = 0;
...
bool tw_control::can_drag(uint click_pos_x, uint click_pos_y)
{
...
uint16_t tw_control::get_height_stacked()
{
	return (height + padding_y * 2);
}

uint16_t tw_control::get_height()
{
	return (height);
}
