...
void ControlButton::draw(uint canvasid)
{
...
bool ControlButton::drag(int16_t drag_x, int16_t drag_y)
{
	return false;
}
...
bool ControlButton::click_double(uint16_t click_pos_x, uint16_t click_pos_y)
{
	return false;
}

bool ControlButton::click_long(uint16_t click_pos_x, uint16_t click_pos_y)
{
	return false;
}
