...
bool WidgetMessage::click(uint16_t click_pos_x, uint16_t click_pos_y)
{
	return false;
}

bool WidgetMessage::click_double(uint16_t click_pos_x, uint16_t click_pos_y)
{
	return false;
}

bool WidgetMessage::click_long(uint16_t click_pos_x, uint16_t click_pos_y)
{
	return false;
}
